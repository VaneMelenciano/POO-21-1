...
public class MiVentana5 extends JFrame {
    ...
    public MiVentana5(){
        ...
        //CREAR UN OBJETO DE TIPO MANEJADOREVENTOSMOUSE
        ManejadorEventoMouse evmouse = new ManejadorEventoMouse();
        boton = new JButton();
        boton.setText("Click me!");
        boton.addMouseListener(evmouse);
        boton2 = new JButton();
        boton2.setText("Cambiar color");
        boton2.addMouseListener(evmouse);
        boton3 = new JButton("cuantos clics");
        //boton3.addMouseListener(this);
        boton4 = new JButton("contador");
        boton4.addMouseListener(evmouse);
        boton5 = new JButton("quinto");
        boton5.addMouseListener(evmouse);
        
        centro = new JPanel();
        centro.setSize(100, 100);
        centro.add(boton);
        centro.addMouseListener(evmouse);
    ...
    //CREACION DE CLASE INTERNA PARA EL MANEJO DE EVENTOS
    
    public class ManejadorEventoMouse implements MouseListener{
    String saludo = "HOLAAA";
